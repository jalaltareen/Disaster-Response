...
def load_data(messages_filepath, categories_filepath):
    ...
    """
    For Loading messages and categories dataset. Merging both datasets on Ids 
    ...
    outputs:
    df: dataframe. Processed and merrged dataset.
...
def clean_data(df):
    ...
    This function is for transform phase. Will clean dataframe by removing 
    duplicates and converting categories from strings to binary value
    
    Args:
    df: dataframe. Dataframe from load data function.
       
    Returns:
    df: dataframe. Cleaned version of Dataframe.
    """
...
def save_data(df, database_filename):
    ...
    """
    Saveing final dataframe into  SQLite database.
    
    inputs:
    df: dataframe. Final and Processed Dataframe
